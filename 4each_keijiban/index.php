...
<body>
  ...
  $pdo = new PDO("mysql:dbname=lesson01;host=localhost;","root","mysql"); //DBへの接続
    ...
    <div class="nyuuryoku">
      ...
      <form method="post" action="insert.php">
        <p>
          <label>ハンドルネーム</label>
          <br>
          <input type="text" class="text" size="35" class="text" name="handlename" />
        </p>
        <p>
          <label>タイトル</label>
          <br>
        ...
        <label>コメント</label>
        <br>
            <textarea cols="65" rows="7" class="textarea" name="comments"></textarea>
        </p>
        <p>
